...
def generate_part_prompt(title: str, outline: str, previous_parts: Optional[List[str]] = None) -> str:
    """
    Part 생성 프롬프트를 생성합니다.
    입력된 previous_parts의 개수로 Part 번호를 자동 판단합니다.

    Args:
        title (str): 드라마 제목
        outline (str): 전체 개요 (outline_full)
        previous_parts (Optional[List[str]]): 이전 Part들의 요약 리스트
                                              None이면 Part 1, 1개면 Part 2, ...
    ...
    Examples:
        >>> # Part 1 생성
        >>> generate_part_prompt("제목", "개요")

        >>> # Part 2 생성
        >>> generate_part_prompt("제목", "개요", ["Part 1 요약"])

        >>> # Part 3 생성
        >>> generate_part_prompt("제목", "개요", ["Part 1 요약", "Part 2 요약"])

        >>> # Part 4 생성
        >>> generate_part_prompt("제목", "개요", ["Part 1 요약", "Part 2 요약", "Part 3 요약"])
    """
