...
def generate_main_images_prompt(
    ...
    """
    Main 이미지 프롬프트 생성 프롬프트를 생성합니다.

    Args:
        part1_summary (str): Part 1 요약
        part2_summary (str): Part 2 요약
        part3_summary (str): Part 3 요약
        part4_summary (str): Part 4 전체 텍스트 (마지막은 요약이 아닌 전체)
